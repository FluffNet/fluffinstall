...
int main()
{
    ...
    if (BOOT_MODE == "UEFI")
    {
        ...
        std::system(("parted --script " + TARGETDISK + " mkpart primary btrfs 5GiB 100%").c_str());
    ...
    std::system("arch-chroot /mnt systemctl enable virtqemud");
    std::system("arch-chroot /mnt systemctl enable virtstoraged");
    std::system("arch-chroot /mnt systemctl enable virtnetworkd");
    std::system("arch-chroot /mnt systemctl enable virtlogd");
    std::system("arch-chroot /mnt systemctl enable virtlockd");
    std::system("arch-chroot /mnt systemctl enable virtnodedevd");
    std::system("arch-chroot /mnt systemctl enable virtsecretd");
